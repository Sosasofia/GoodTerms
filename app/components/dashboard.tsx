                ...
                <div>
                    ...
                    <div className="flex flex-wrap items-center gap-3 mt-2 text-sm font-medium">
                        <span className="bg-slate-100 text-slate-600 px-3 py-1 rounded-md font-mono border border-slate-200">
                            Code: <span className="font-bold text-slate-900 select-all">{group.code}</span>
                        </span>
                        ...
                        {group.pin && (
                            <span className="bg-yellow-50 text-yellow-700 px-3 py-1 rounded-md font-mono border border-yellow-200 flex items-center gap-1">
                                🔒 PIN: <span className="font-bold select-all">{group.pin}</span>
                            </span>
                        )}
                    </div>
                </div>
            ...
            <div className="grid grid-cols-3 gap-2 mb-8">
                {group.members.map((u) => {
                    ...
                    return (
                        <div
                            key={u.id}
                            className={`p-2 rounded-lg text-center border transition-colors ${isPositive ? "bg-green-50 border-green-200" : "bg-red-50 border-red-200"
                                }`}
                        >
                            <div className="font-bold text-sm truncate text-slate-700">{u.name}</div>
